...
<div class="container my-25">
    ...
    <!-- Search Section -->
<form method="GET" action="{{ route('welfare.memorandum') }}" class="bg-white rounded shadow p-4 mb-5" id="searchFilterForm">
    <div class="row g-4 align-items-end">
        <div class="col-md-6">
            <label for="searchInput" class="form-label">Search</label>
            <div class="input-group">
                <input type="text" id="searchInput" name="search" value="{{ request('search') }}" placeholder="Search by issuance number or subject" class="form-control" autocomplete="off">
            </div>
        </div>
...
<script>
$(function() {
    // If search input is cleared, reset award_type to 'all' and submit form
        ...
        <div class="modal-dialog modal-lg">
            <form method="POST" action="{{ route('memorandums.store') }}" enctype="multipart/form-data" class="modal-content" id="memorandumForm">
                ...
                <div class="modal-body">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="issuance_number" class="form-label">Issuance Number <span class="text-danger">*</span></label>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="award_type" class="form-label">Award Type <span class="text-danger">*</span></label>
